    ...
    <div className="min-h-screen bg-gradient-to-br from-green-50 via-emerald-50 to-teal-50 text-gray-900">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <section className="grid lg:grid-cols-2 gap-12 items-center mb-14">
          <div>
            ...
            <h2 className="text-4xl sm:text-5xl font-bold leading-tight mb-5">
              ...
              <span className="text-green-600">ekosistem hijau</span> untuk UMKM
              Indonesia.
            </h2>
            <p className="text-lg text-gray-600 mb-8 max-w-xl leading-relaxed">
              Fakhara AI mengukur dampak lingkungan bisnis kamu, menyusun
              rencana aksi, dan menghubungkannya ke modal — lewat GreenLend,
              platform kredit berbasis skor SDG/ESG.
            </p>
              ...
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <p className="text-sm text-gray-500">
                    UMKM perlu cara sederhana untuk mulai hijau dan dapat modal.
                  </p>
                </div>
              </div>
        ...
        <section className="mb-14">
          <div className="text-center mb-8">
            ...
            <h2 className="text-3xl font-bold text-gray-900 mb-2">
              Satu ekosistem, dua platform
            </h2>
            <p className="text-gray-500 max-w-xl mx-auto text-sm">
              Fakhara AI dan GreenLend bekerja bersama — dari audit emisi hingga
              akses pembiayaan mikro berbasis dampak hijau.
            </p>
          </div>
          ...
          <div className="grid lg:grid-cols-3 gap-4 items-center">
            ...
            <Card className="border-0 shadow-lg bg-gradient-to-br from-green-600 to-emerald-700 text-white">
              <CardContent className="p-6">
                ...
                <p className="text-sm text-white/80 mb-4">
                  Platform audit karbon & keberlanjutan berbasis AI untuk UMKM
                  Indonesia.
                </p>
            ...
            <Card className="border-0 shadow-lg bg-gradient-to-br from-teal-600 to-cyan-700 text-white">
              <CardContent className="p-6">
                ...
                <p className="text-sm text-white/80 mb-4">
                  Platform kredit mikro berbasis AI yang menggunakan skor
                  SDG/ESG sebagai faktor kelayakan pinjaman.
                </p>
                <div className="space-y-2 text-sm">
                  {[
                ...
                <a
                  href="https://greenlend.elpeef.com"
                  target="_blank"
              ...
              <CardContent className="p-5 flex items-start gap-4">
                ...
                <div>
                  <p className="font-semibold text-gray-800 text-sm">
                    GreenLend — 🥇 Juara 1, NYU Shanghai 2025
                  </p>
                  <p className="text-xs text-gray-500 mt-1 leading-relaxed">
                    Platform mitra kami memenangkan Digital Innovation Challenge
                    di NYU Shanghai tahun 2025 dengan konsep kredit berbasis
                    skor SDG. Fakhara AI adalah jembatannya — dari emisi ke
                    modal.
                  </p>
                </div>
              </CardContent>
            ...
            <Card className="border-0 shadow-sm bg-white">
              <CardContent className="p-6">
                ...
                <p className="text-sm text-gray-600 mb-4">
                  Tambah bisnis pertama kamu. Dashboard langsung terisi dengan
                  audit, rencana aksi, dan skor GreenLend-mu.
                </p>
        ...
        <div className="text-center py-4 text-xs text-gray-400 flex items-center justify-center gap-2">
          ...
          Fakhara AI · Intelligent by Design, Elegant by Nature · Technofest
          2026
        </div>
      </div>
    </div>
